#!/usr/bin/env python3
"""Train experiment 2:nn from replay-derived datasets.
...
from services.games.chess_nn import (  # noqa: E402
    ...
    train_experiment_nn_from_replay_samples,
)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train exp2 from replay-derived external datasets.")
