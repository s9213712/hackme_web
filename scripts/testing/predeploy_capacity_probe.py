...
def exercise_root_points_chain(base_url: str, args: argparse.Namespace) -> list[dict[str, Any]]:
    ...
    _append_request(samples, client, "POST", "/api/root/trading/sitewide/refresh", json_body={}, expected={200}, label="root trading snapshots refresh")
    _append_request(samples, client, "GET", "/api/root/trading/verify", expected={200}, label="root trading verify")
