...
from scripts.security.server_mode.server_mode_v2_clean_smoke import SmokeRuntime  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("--out", default=str(security_reports_root()), help="Report output directory.")
