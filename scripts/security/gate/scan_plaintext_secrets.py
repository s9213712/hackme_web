...
DEFAULT_MD_REPORT = security_reports_root() / "secrets_scan_report.md"
DEFAULT_ALLOWLIST = Path(__file__).resolve().with_name("secrets_allowlist.yml")
...
REPORT_GLOBS = {
    "runtime/reports/security/*.json",
    "runtime/reports/security/*.md",
}
SAFE_DYNAMIC_RHS = {
    "csrf",
    "currentPassword",
