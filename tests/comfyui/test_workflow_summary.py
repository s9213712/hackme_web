...
def test_workflow_summary_detects_unet_clip_and_embedding_dependencies():
    workflow = {
        "1": {"class_type": "UNETLoader", "inputs": {"unet_name": "anima-preview3-base.safetensors"}},
    ...
    assert ("diffusion_model", "anima-preview3-base.safetensors") in required
    ...
    assert summary["default_params"]["diffusion_model"] == "anima-preview3-base.safetensors"
