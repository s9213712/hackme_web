...
def test_external_chain_features_remain_disabled_by_rc1_scope():
    scope_path = ROOT / "docs" / "RELEASE" / "RC1_SCOPE.md"
    backlog_path = ROOT / "docs" / "BLOCKCHAIN" / "POST_RC1_BACKLOG.md"
    matrix_path = ROOT / "docs" / "BLOCKCHAIN" / "POINTSCHAIN_REAL_INCIDENT_GAP_MATRIX.md"
    if scope_path.exists() and backlog_path.exists() and matrix_path.exists():
