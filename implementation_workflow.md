...
- [x] 跑完整 pytest：`19 passed`
- [ ] 權限 middleware 統一化：role / member_level / status 三層檢查
- [ ] Security events event_type 覆蓋盤點與缺口補齊
- [ ] CSRF 覆蓋盤點
- [ ] Rate limit 覆蓋盤點
- [ ] Session 管理安全盤點
...
- [ ] 密碼強度評分 `password_strength_score` 0-4
- [ ] 同帳號暴力破解鎖定：`failed_login_attempts` + `locked_until`
