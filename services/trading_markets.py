...
TRADING_MARKET_CATALOG = (
    ...
    },
    {
        ...
        "quote_currency": "POINTS",
        "display_quote_currency": "USDT",
        "default_manual_price_points": 3,
        "sort_order": 30,
        "live_price_enabled": True,
        "reference_price_enabled": True,
        "btc_trade_enabled": False,
        "provider_ids": {
            "binance_public_api": "XRPUSDT",
            "okx_public_api": "XRP-USDT",
            "coinbase_exchange": "XRP-USD",
            "kraken_public_api": "XRPUSD",
            "gemini_public_api": "",
            "bitstamp_public_api": "xrpusd",
            "coingecko_simple_price": "ripple",
        },
    },
    {
        "symbol": "BNB/POINTS",
        ...
        "quote_currency": "POINTS",
        "display_quote_currency": "USDT",
        "default_manual_price_points": 700,
        "sort_order": 40,
        "live_price_enabled": True,
        "reference_price_enabled": True,
        "btc_trade_enabled": False,
        "provider_ids": {
            "binance_public_api": "BNBUSDT",
            "okx_public_api": "BNB-USDT",
            "coinbase_exchange": "",
            "kraken_public_api": "",
            "gemini_public_api": "",
            "bitstamp_public_api": "",
            "coingecko_simple_price": "binancecoin",
        },
    },
    {
        "symbol": "PAXG/POINTS",
        ...
        "quote_currency": "POINTS",
        "display_quote_currency": "USDT",
        "default_manual_price_points": 3300,
        "sort_order": 50,
        "live_price_enabled": True,
        "reference_price_enabled": True,
        "btc_trade_enabled": False,
        "provider_ids": {
            "binance_public_api": "PAXGUSDT",
            "okx_public_api": "",
            "coinbase_exchange": "",
            "kraken_public_api": "",
            "gemini_public_api": "",
            "bitstamp_public_api": "",
            "coingecko_simple_price": "pax-gold",
        },
    },
)
