...
def _pipeline_defaults() -> dict:
    ...
    return {
        ...
        "commands": {
            ...
            "full_pipeline": "python3 scripts/games/chess_train_pipeline.py --preset standard --include-exp2 --promote-engines 'experiment 2:nn,experiment 3:dl,experiment 4:pv'",
        },
    }
