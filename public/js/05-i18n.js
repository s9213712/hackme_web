...
(function setupHackmeI18n() {
  ...
  const EN_TEXT = Object.freeze({
    ...
    'E2EE 影音可設公開；公開播放時需輸入原始 E2EE 密碼並在瀏覽器端解密。持連結分享會改用片段金鑰授權；若遺失完整分享連結中的片段金鑰，伺服器無法復原，只能重新產生分享。': 'E2EE media can be public; public playback requires the original E2EE password and decrypts in the browser. Link sharing uses a fragment key; if that key is lost, the server cannot recover it and the share must be regenerated.',
