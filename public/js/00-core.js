...
const SIDEBAR_MENU_CONFIG = [
  ...
  { tabId: "tab-module-web-terminal", role: "root", tab: "web-terminal", icon: "terminal", label: "WebTerminal", group: "工具" },
...
function setAuthState(json, showLoginHero = false) {
  ...
  if (tabModuleWebTerminal) tabModuleWebTerminal.style.display = currentUser === "root" ? "" : "none";
