...
> - 使用本文件與 `docs/BLOCKCHAIN/` 正式規格作為 canonical source
> - 保持主線工作樹乾淨、test 全綠
...
GATE_REPORT.md 模板可沿用既有 `docs/AGENTS/reports/*` 的報告格式：Verdict / Branch / Commit / Coverage Matrix / Findings / Required Fixes，但 canonical 狀態仍以 `docs/BLOCKCHAIN/` 為準。
