...
- `services/trading_engine.py` — `get_max_backtest_candles()` / `record_backtest_capacity_measurement()` / `_settings_payload()`
...
- `security/workflow_template_backtest_benchmark.py` — 主腳本（接 `--interval` / `--use-relative-thresholds`）
...
python security/workflow_template_backtest_benchmark.py --interval 1h

# 1h 相對值版（產出 _1h_relative.json，gitignored）
python security/workflow_template_backtest_benchmark.py --interval 1h --use-relative-thresholds

# 其他間隔
python security/workflow_template_backtest_benchmark.py --interval 5m  --use-relative-thresholds
python security/workflow_template_backtest_benchmark.py --interval 15m --use-relative-thresholds
python security/workflow_template_backtest_benchmark.py --interval 4h  --use-relative-thresholds
python security/workflow_template_backtest_benchmark.py --interval 4d  --use-relative-thresholds
```
