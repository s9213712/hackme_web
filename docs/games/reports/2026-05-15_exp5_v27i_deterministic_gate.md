...
|---|---:|---:|---:|---:|---|
| complete_game | 453 | 399 | -54 | 407 | True |
| tail50pct | 205 | 182 | -23 | 184 | True |
| tail25pct | 126 | 100 | -26 | 113 | True |

## Secondary Metrics

- Total rejected baseline/candidate: `827` / `714`
- Clean rate baseline/candidate: `0.6572` / `0.694`
- Review+ rate baseline/candidate: `0.8212` / `0.8456`
- Top5 rate baseline/candidate: `0.5149` / `0.5586`
...
- `complete_game`: baseline `402`, candidate `350`, delta `-52`
- `tail10pct`: baseline `34`, candidate `25`, delta `-9`
