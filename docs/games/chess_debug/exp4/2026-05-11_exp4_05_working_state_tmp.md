...
```bash
python3 -m py_compile /home/s92137/hackme_web/scripts/games/chess_live_learning_validation.py /home/s92137/hackme_web/services/games/chess_pv.py /home/s92137/hackme_web/services/games/self_play_training.py
```

已通過：

```bash
PYTHONPATH=/home/s92137/hackme_web python3 -m pytest /home/s92137/hackme_web/tests/scripts/games/test_chess_live_learning_validation_script.py -q
```
...
```bash
PYTHONPATH=/home/s92137/hackme_web python3 -m pytest /home/s92137/hackme_web/tests/games -q
```
...
```bash
PYTHONPATH=/home/s92137/hackme_web python3 -m pytest /home/s92137/hackme_web/tests/scripts/games/test_chess_live_learning_validation_script.py::test_exp4_opening_target_margin_audit_reports_mcts_and_multigood /home/s92137/hackme_web/tests/games/test_games.py::test_experiment_pv_mcts_decision_explain_reports_root_stats -q
```
...
```text
/home/s92137/chess_results/exp4_05_opening_margin_mcts_alignment
```
...
```text
/home/s92137/chess_results/exp4_05_opening_margin_mcts_alignment_rerun
```
...
```text
/home/s92137/chess_results/exp4_05_opening_margin_mcts_alignment_fixed
```
...
```bash
python3 /home/s92137/hackme_web/scripts/games/chess_exp4_dataset_train.py --input-jsonl /home/s92137/chess_results/exp4_05_opening_margin_mcts_alignment_fixed/exp4/checkpoints/10/train_dataset.jsonl --model-path /tmp/exp4_probe_model.json --max-samples 32
```
...
```bash
python3 /home/s92137/hackme_web/scripts/games/chess_exp4_dataset_train.py --input-jsonl /home/s92137/chess_results/exp4_05_opening_margin_mcts_alignment_fixed/exp4/checkpoints/10/train_dataset.jsonl --model-path /tmp/exp4_probe_model_64.json --max-samples 64
```
結果：
...
```text
/home/s92137/chess_results/exp4_05_opening_margin_mcts_alignment_sample64
```
...
```bash
python3 /home/s92137/hackme_web/scripts/games/chess_live_learning_validation.py --engines exp4 --quick-retrain-gate --seed 20260511 --output-root /home/s92137/chess_results/exp4_05_opening_margin_mcts_alignment_sample64_retry
```
