...
```bash
PYTHONPATH=/home/s92137/hackme_web python3 /home/s92137/hackme_web/scripts/games/chess_live_learning_validation.py --engines exp2 --semantic-specialist-probes --output-root /home/s92137/chess_results/exp24_kingside_development_audit
```
...
最後一次 run 原始結果目錄：`/home/s92137/chess_results/exp24_kingside_development_audit`。
