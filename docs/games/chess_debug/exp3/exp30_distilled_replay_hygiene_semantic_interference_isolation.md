...
```bash
PYTHONPATH=/home/s92137/hackme_web python3 /home/s92137/hackme_web/scripts/games/chess_live_learning_validation.py --engines exp3 --quick-retrain-gate --output-root /home/s92137/chess_results/exp30a_distilled_replay_leakage_fix_evaluation_cache
```
### exp30b_semantic_interference_isolation
```bash
PYTHONPATH=/home/s92137/hackme_web python3 /home/s92137/hackme_web/scripts/games/chess_live_learning_validation.py --engines exp3 --quick-retrain-gate --semantic-specialist-probes --output-root /home/s92137/chess_results/exp30b_semantic_interference_isolation
```
...
最後一次 run 原始結果目錄：`/home/s92137/chess_results/exp30b_semantic_interference_isolation`。
