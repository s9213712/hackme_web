...
```bash
PYTHONPATH=/home/s92137/hackme_web python3 /home/s92137/hackme_web/scripts/games/chess_live_learning_validation.py --engines exp3 --quick-retrain-gate --output-root /home/s92137/chess_results/exp18_semantic_embedding_separation
```
### exp18_semantic_embedding_separation_r2
```bash
PYTHONPATH=/home/s92137/hackme_web python3 /home/s92137/hackme_web/scripts/games/chess_live_learning_validation.py --engines exp3 --quick-retrain-gate --output-root /home/s92137/chess_results/exp18_semantic_embedding_separation_r2
```
...
最後一次 run 原始結果目錄：`/home/s92137/chess_results/exp18_semantic_embedding_separation_r2`。
