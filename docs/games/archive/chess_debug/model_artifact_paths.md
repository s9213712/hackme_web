...
- runtime source：`<chess_results>/exp34_mixed_scheduler_repair_hard_case_decision_audit_fixed/exp3/checkpoints/20/exp3_quick_candidate_model.json`
...
- baseline exp5 model：`<repo>/services/games/models/chess_experiment_5_nnue.json`
...
- held-out output（run）：`<chess_results>/exp5_03_repeatability_fix3/heldout_rows_exp5_03.jsonl`（24 筆）
- smoke output（run）：`<chess_results>/exp5_03_repeatability_fix3/smoke_rows_exp5_03.jsonl`（4 筆）
- focused benchmark report：`/tmp/hackme_exp5_01_real_dry_run/benchmark_focused_report.json`
- repeatability report：`<chess_results>/exp5_03_repeatability_fix3/chess_exp5_repeatability_20260511_082907.153618.json`
- repeatability md：`<chess_results>/exp5_03_repeatability_fix3/chess_exp5_repeatability_20260511_082907.153618.md`
- run_1 candidate（seed 11）：`<chess_results>/exp5_03_repeatability_fix3/run_1_seed_11/candidate/chess_experiment_5_nnue.json`
  - sha256：`c2d464d38bda8c038e0dd729ff4da390ba1958260d2d575a8f1666d5924f041f`
- run_2 candidate（seed 12）：`<chess_results>/exp5_03_repeatability_fix3/run_2_seed_12/candidate/chess_experiment_5_nnue.json`
  - sha256：`8a61db88c41fccc54717dc27afe3e3dda997014ae926553a905357bffa28806f`
- run_3 candidate（seed 13）：`<chess_results>/exp5_03_repeatability_fix3/run_3_seed_13/candidate/chess_experiment_5_nnue.json`
  - sha256：`38fe192712c4b1086846cf67c80273b4f387208e04f4f82326b7bd5122dc970e`
- gate payload（固定）：`<repo>/services/games/chess_exp5_strength_gate.py`
...
- baseline exp5 model：`<repo>/services/games/models/chess_experiment_5_nnue.json`
- baseline sha256：`6fbafae703b94c173e10079aae09763a547719b410895332cbbfdf990ca487ec`
- stage candidate model：`<chess_results>/exp5_07_stage_candidate/chess_experiment_5_nnue_stage_candidate.json`
- stage candidate sha256：`f0bfa376432b734994a7e8b7e9af3cfd74211b6ee7f054959b7d2c258fd2378f`
- source distill：`<chess_results>/exp5_06_clean_pool/inputs/exp5_06_train_clean_only.jsonl`（60 rows, all `label_quality=clean`）
...
- strength gate dry-run：`<chess_results>/exp5_07_stage_candidate/stage_gate_dry_run.json`
- repeatability rerun (3 seeds)：`<chess_results>/exp5_06_clean_pool/ablation/cell_B_e4_t2_exp507_rerun/stdout.json`
...
- baseline exp5 model：`<repo>/services/games/models/chess_experiment_5_nnue.json`
- baseline sha256：`6fbafae703b94c173e10079aae09763a547719b410895332cbbfdf990ca487ec`
- stage candidate model：`<chess_results>/exp5_08_stage_candidate/chess_experiment_5_nnue_stage_candidate.json`
- stage candidate sha256：`c47ef752aa69d7b8c813b587468228593f44d69c9b947313325e03797e4450dc`
- distill (full)：`<chess_results>/exp5_08_clean_pool/distill/exp5_08_distill.jsonl`（341 rows after legal/suspicious filter）
- training input：`<chess_results>/exp5_08_clean_pool/inputs/exp5_08_train_clean_only.jsonl`（116 rows, all `label_quality=clean`, dataset_hash16 `9accbee6b540be89`）
- training config：epochs=4, auto-hard-negative-topk=2, multi-good-margin-cp=30.0, label-quality-weight={clean=1.0, review=0.4, questionable=0.0}, search-profile=fixed_depth_strong
- strength cases：`<chess_results>/exp5_08_clean_pool/inputs/exp5_08_strength_cases.jsonl`（64 eval-bucket cases, position_id-hashed split, 25 clean / 1 review / 38 quest）
- ablation root：`<chess_results>/exp5_08_clean_pool/ablation/cell_B_e4_t2_smokefix/`
...
- focused benchmark cases：`<chess_results>/exp5_08_clean_pool/inputs/exp5_09_benchmark_cases.jsonl`（68 cases, sha16 `ae0de9005d77fd0b`, 含 4 added smoke）
- focused benchmark report：`<chess_results>/exp5_09_focused_benchmark/focused_benchmark.json`
- strength gate with benchmark：`<chess_results>/exp5_09_focused_benchmark/stage_gate_with_bench.json`
- repeatability with benchmark (3 seeds)：`<chess_results>/exp5_09_focused_benchmark/repeat/stdout.json`
...
- baseline model：`<repo>/services/games/models/chess_experiment_5_nnue.json`（sha256 `6fbafae703b94c173e10079aae09763a547719b410895332cbbfdf990ca487ec`）
- candidate model：`<chess_results>/exp5_08_stage_candidate/chess_experiment_5_nnue_stage_candidate.json`（sha256 `c47ef752aa69d7b8c813b587468228593f44d69c9b947313325e03797e4450dc`）
- production readiness root：`<chess_results>/exp5_10_production_readiness/`
- cases：`<chess_results>/exp5_10_production_readiness/exp5_10_benchmark_cases.jsonl`（135 cases, 70 true held-out）
- expanded benchmark：`<chess_results>/exp5_10_production_readiness/focused_benchmark_expanded.json`
- strength gate expanded：`<chess_results>/exp5_10_production_readiness/strength_gate_expanded.json`
...
- runtime check：bundled baseline unchanged; production runtime path `<repo>/runtime/games/models/chess_experiment_5_nnue.json` did not exist before/after, so `production_runtime_model_checked=false`, `production_runtime_unchanged=true_by_no_write_only`
...
- audit root：`<chess_results>/exp5_11b_quiet_regression_audit/`
- rows：`<chess_results>/exp5_11b_quiet_regression_audit/quiet_regression_rows.jsonl`
- summary：`<chess_results>/exp5_11b_quiet_regression_audit/summary.json`
- markdown summary：`<chess_results>/exp5_11b_quiet_regression_audit/SUMMARY.md`
...
- exp5_10 rerun summary：`<chess_results>/exp5_10_production_readiness/summary.json`
- strength gate summary：`<chess_results>/exp5_10_production_readiness/strength_gate_expanded.json`
- post-fix quiet audit：`<chess_results>/exp5_11b_quiet_regression_audit/summary.json`（`quiet_clean_regression_count=0`）
...
- promotion summary：`<chess_results>/exp5_12_production_promote/summary.json`
- promoted candidate artifact：`<chess_results>/exp5_08_stage_candidate/chess_experiment_5_nnue_stage_candidate.json`
- candidate sha256：`c47ef752aa69d7b8c813b587468228593f44d69c9b947313325e03797e4450dc`
- runtime production model：`<repo>/runtime/games/models/chess_experiment_5_nnue.json`
- staged runtime candidate：`<repo>/runtime/games/models/candidates/experiment_5_nnue`
- previous runtime existed：`False`
- rollback marker：`<chess_results>/exp5_12_production_promote/rollback/previous_runtime_absent.json`
- post-promote validation summary：`<chess_results>/exp5_12_post_promote_check/summary.json`
- post-promote benchmark：`<chess_results>/exp5_12_post_promote_check/focused_benchmark_expanded.json`
- post-promote strength gate：`<chess_results>/exp5_12_post_promote_check/strength_gate_expanded.json`
- post-promote repeatability：`<chess_results>/exp5_12_post_promote_check/repeatability_5_seed.json`
...
- validation summary：`<chess_results>/exp5_13_rule_smoke_stalemate_fix_check/summary.json`
...
- output root：`<chess_results>/exp5_14_opening_label_audit/`
...
- opening fail rows：`<chess_results>/exp5_14_opening_label_audit/opening_fail_rows.jsonl`
...
- output root：`<chess_results>/exp5_14b_clean_opening_heldout/`
- summary：`<chess_results>/exp5_14b_clean_opening_heldout/summary.json`
- clean opening cases：`<chess_results>/exp5_14b_clean_opening_heldout/clean_opening_cases.jsonl`
- clean opening held-out：`<chess_results>/exp5_14b_clean_opening_heldout/clean_opening_heldout.jsonl`
- clean opening curriculum：`<chess_results>/exp5_14b_clean_opening_heldout/clean_opening_curriculum.jsonl`
- evaluation：`<chess_results>/exp5_14b_clean_opening_heldout/clean_opening_evaluation.json`
- raw curated rows：`40`
...
- evaluation model：`<chess_results>/exp5_08_stage_candidate/chess_experiment_5_nnue_stage_candidate.json`
...
- output root：`<chess_results>/exp5_15_opening_candidate_search/`
- summary：`<chess_results>/exp5_15_opening_candidate_search/summary.json`
- summary md：`<chess_results>/exp5_15_opening_candidate_search/SUMMARY.md`
- opening samples：`<chess_results>/exp5_15_opening_candidate_search/opening_train_samples.jsonl`
- retention samples：`<chess_results>/exp5_15_opening_candidate_search/retention_train_samples.jsonl`
...
- A candidate：`<chess_results>/exp5_15_opening_candidate_search/A_opening_only_e8_hn4/chess_experiment_5_nnue_candidate.json`
...
- B candidate：`<chess_results>/exp5_15_opening_candidate_search/B_opening_retention_e8_hn4/chess_experiment_5_nnue_candidate.json`
...
- output root：`<chess_results>/exp5_16_opening_overlay_candidate/`
- summary：`<chess_results>/exp5_16_opening_overlay_candidate/summary.json`
- summary md：`<chess_results>/exp5_16_opening_overlay_candidate/SUMMARY.md`
- candidate model：`<chess_results>/exp5_16_opening_overlay_candidate/chess_experiment_5_nnue_opening_overlay_candidate.json`
- overlay payload：`<chess_results>/exp5_16_opening_overlay_candidate/opening_overlay.json`
- opening evaluation：`<chess_results>/exp5_16_opening_overlay_candidate/opening_evaluation.json`
- retention evaluation：`<chess_results>/exp5_16_opening_overlay_candidate/retention_evaluation.json`
- repeatability：`<chess_results>/exp5_16_opening_overlay_candidate/repeatability_5_seed.json`
- current production sha actual：`c47ef752aa69d7b8c813b587468228593f44d69c9b947313325e03797e4450dc`
...
- output root：`<chess_results>/exp5_17_opening_overlay_staging_validation/`
- summary：`<chess_results>/exp5_17_opening_overlay_staging_validation/summary.json`
- summary md：`<chess_results>/exp5_17_opening_overlay_staging_validation/SUMMARY.md`
- opening evaluation：`<chess_results>/exp5_17_opening_overlay_staging_validation/opening_evaluation.json`
- retention evaluation：`<chess_results>/exp5_17_opening_overlay_staging_validation/retention_evaluation.json`
- overlay activation audit：`<chess_results>/exp5_17_opening_overlay_staging_validation/overlay_activation_audit.json`
- fresh non-overlay opening audit：`<chess_results>/exp5_17_opening_overlay_staging_validation/fresh_non_overlay_opening_audit.json`
- runtime priority safety audit：`<chess_results>/exp5_17_opening_overlay_staging_validation/runtime_priority_safety_audit.json`
- repeatability：`<chess_results>/exp5_17_opening_overlay_staging_validation/repeatability_5_seed.json`
- candidate path：`<chess_results>/exp5_16_opening_overlay_candidate/chess_experiment_5_nnue_opening_overlay_candidate.json`
- candidate sha：`d35c04707fd7c10e8b6efe07740e69da533dea524d31aa63308afea891d006c9`
- current production sha actual：`c47ef752aa69d7b8c813b587468228593f44d69c9b947313325e03797e4450dc`
- clean opening result：current `1/31 = 0.032258`, candidate `31/31 = 1.0`, delta `+0.967742`
...
- review summary：`<chess_results>/exp5_18_opening_overlay_promotion_review/summary.json`
- review summary md：`<chess_results>/exp5_18_opening_overlay_promotion_review/SUMMARY.md`
- candidate path：`<chess_results>/exp5_16_opening_overlay_candidate/chess_experiment_5_nnue_opening_overlay_candidate.json`
- candidate sha：`d35c04707fd7c10e8b6efe07740e69da533dea524d31aa63308afea891d006c9`
- runtime path：`<repo>/runtime/games/models/chess_experiment_5_nnue.json`
- runtime exists at review time：`false`
- fallback production-equivalent path：`<chess_results>/exp5_08_stage_candidate/chess_experiment_5_nnue_stage_candidate.json`
- fallback production-equivalent sha：`c47ef752aa69d7b8c813b587468228593f44d69c9b947313325e03797e4450dc`
- exp5_17 summary：`<chess_results>/exp5_17_opening_overlay_staging_validation/summary.json`
- W7 dry-run smoke aggregate：`<chess_results>/exp5_18_w7_dryrun_smoke/pipeline_run_20260512T130122_069288Z/06_aggregate/pipeline_summary.json`
...
- rollback if runtime exists：restore backup from `<chess_results>/exp5_18_promotion_backup/`
...
- post-promotion summary：`<chess_results>/exp5_final_promotion_postverify/summary.json`
- clean opening：`31/31`
- retention：`115/137`
- clean regression：`0`
