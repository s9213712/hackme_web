...
- candidate artifact: `<chess_results>/exp5_08_stage_candidate/chess_experiment_5_nnue_stage_candidate.json`
...
- bundled baseline seed: `<repo>/services/games/models/chess_experiment_5_nnue.json`
...
- rollback instruction: delete `<repo>/runtime/games/models/chess_experiment_5_nnue.json` to restore the pre-promote absent-runtime state
...
- post-promote output dir: `<chess_results>/exp5_12_post_promote_check/`
- summary: `<chess_results>/exp5_12_post_promote_check/summary.json`
- benchmark: `<chess_results>/exp5_12_post_promote_check/focused_benchmark_expanded.json`
- strength gate: `<chess_results>/exp5_12_post_promote_check/strength_gate_expanded.json`
- repeatability: `<chess_results>/exp5_12_post_promote_check/repeatability_5_seed.json`
