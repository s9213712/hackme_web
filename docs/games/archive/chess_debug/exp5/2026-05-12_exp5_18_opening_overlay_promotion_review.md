...
- path: `<chess_results>/exp5_16_opening_overlay_candidate/chess_experiment_5_nnue_opening_overlay_candidate.json`
...
- fallback path: `<chess_results>/exp5_08_stage_candidate/chess_experiment_5_nnue_stage_candidate.json`
...
- summary JSON: `<chess_results>/exp5_18_opening_overlay_promotion_review/summary.json`
- summary md: `<chess_results>/exp5_18_opening_overlay_promotion_review/SUMMARY.md`
...
- output root: `<chess_results>/exp5_18_w7_dryrun_smoke/pipeline_run_20260512T130122_069288Z`
- exp5 model path: `<chess_results>/exp5_16_opening_overlay_candidate/chess_experiment_5_nnue_opening_overlay_candidate.json`
- aggregate summary: `<chess_results>/exp5_18_w7_dryrun_smoke/pipeline_run_20260512T130122_069288Z/06_aggregate/pipeline_summary.json`
- aggregate md: `<chess_results>/exp5_18_w7_dryrun_smoke/pipeline_run_20260512T130122_069288Z/06_aggregate/PIPELINE_SUMMARY.md`
...
3. Rollback by deleting `<repo>/runtime/games/models/chess_experiment_5_nnue.json`, restoring fallback behavior to sha `c47ef752...`.

If the runtime file exists at promotion time:

1. Copy the current runtime file to `<chess_results>/exp5_18_promotion_backup/`.
