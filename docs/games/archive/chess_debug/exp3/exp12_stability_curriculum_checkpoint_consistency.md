...
```bash
PYTHONPATH=<repo> python3 <repo>/scripts/games/chess_live_learning_validation.py --engines exp3 --quick-retrain-gate --output-root <chess_results>/exp12_exp3_quick_gate_20260510T_exp12
```
### exp12_exp3_quick_gate_20260510T_exp12_r2
```bash
PYTHONPATH=<repo> python3 <repo>/scripts/games/chess_live_learning_validation.py --engines exp3 --quick-retrain-gate --output-root <chess_results>/exp12_exp3_quick_gate_20260510T_exp12_r2
```
### exp12_exp3_quick_gate_20260510T_exp12_r3
```bash
PYTHONPATH=<repo> python3 <repo>/scripts/games/chess_live_learning_validation.py --engines exp3 --quick-retrain-gate --output-root <chess_results>/exp12_exp3_quick_gate_20260510T_exp12_r3
```
### exp12_exp3_quick_gate_20260510T_exp12_r4
```bash
PYTHONPATH=<repo> python3 <repo>/scripts/games/chess_live_learning_validation.py --engines exp3 --quick-retrain-gate --output-root <chess_results>/exp12_exp3_quick_gate_20260510T_exp12_r4
```
### exp12_exp3_quick_gate_20260510T_exp12_r5
```bash
PYTHONPATH=<repo> python3 <repo>/scripts/games/chess_live_learning_validation.py --engines exp3 --quick-retrain-gate --output-root <chess_results>/exp12_exp3_quick_gate_20260510T_exp12_r5
```
...
最後一次 run 原始結果目錄：`<chess_results>/exp12_exp3_quick_gate_20260510T_exp12_r5`。
