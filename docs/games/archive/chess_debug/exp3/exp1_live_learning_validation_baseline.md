...
```bash
PYTHONPATH=<repo> python3 <repo>/scripts/games/chess_live_learning_validation.py --engines exp3 --output-root <chess_results>/live_learning_20260509_235218
```
...
最後一次 run 原始結果目錄：`<chess_results>/live_learning_20260509_235218`。
