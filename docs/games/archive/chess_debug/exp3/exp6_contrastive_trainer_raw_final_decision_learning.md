...
```bash
PYTHONPATH=<repo> python3 <repo>/scripts/games/chess_live_learning_validation.py --engines exp3 --quick-retrain-gate --output-root <chess_results>/exp6_exp3_quick_gate_20260510
```
### exp6_quick_gate_20260510_092501
```bash
PYTHONPATH=<repo> python3 <repo>/scripts/games/chess_live_learning_validation.py --engines exp3 --quick-retrain-gate --output-root <chess_results>/exp6_quick_gate_20260510_092501
```
### exp6_quick_gate_20260510_092501_final
```bash
PYTHONPATH=<repo> python3 <repo>/scripts/games/chess_live_learning_validation.py --engines exp3 --quick-retrain-gate --output-root <chess_results>/exp6_quick_gate_20260510_092501_final
```
### exp6_quick_gate_20260510_092501_rerun
```bash
PYTHONPATH=<repo> python3 <repo>/scripts/games/chess_live_learning_validation.py --engines exp3 --quick-retrain-gate --output-root <chess_results>/exp6_quick_gate_20260510_092501_rerun
```
...
最後一次 run 原始結果目錄：`<chess_results>/exp6_quick_gate_20260510_092501_rerun`。
