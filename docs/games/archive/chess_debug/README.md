...
- result：`<chess_results>/exp4_16_rule_aware_final_fusion_locked`
...
- result dir：`<chess_results>/exp4_19_guarded_overlay_attribution`
...
- result dir：`<chess_results>/exp4_20_runtime_guarded_overlay`
...
- quick result dir：`<chess_results>/exp4_22_actual_runtime_guarded_overlay_quick`
- full result dir：`<chess_results>/exp4_22_actual_runtime_guarded_overlay_full`
...
- quick result dir：`<repo>/runtime/chess_results/exp4_23_guarded_overlay_broad_sanity_gate_quick`
- full result dir：`<repo>/runtime/chess_results/exp4_23_guarded_overlay_broad_sanity_gate_full`
...
- input result dir：`<repo>/runtime/chess_results/exp4_23_guarded_overlay_broad_sanity_gate_full`
- output JSON：`<repo>/runtime/chess_results/exp4_23_guarded_overlay_broad_sanity_gate_full/exp4/audits/exp4_guarded_overlay_unsafe_override_audit.json`
...
- [`exp5/`](exp5/)
- latest learning ledger：[`exp5/2026-05-12_exp5_16_opening_overlay_candidate.md`](exp5/2026-05-12_exp5_16_opening_overlay_candidate.md)
