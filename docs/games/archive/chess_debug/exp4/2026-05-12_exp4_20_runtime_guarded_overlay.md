...
PYTHONPATH=<repo> python3 <repo>/scripts/games/chess_live_learning_validation.py \
  ...
  --output-root <chess_results>/exp4_20_runtime_guarded_overlay
```

結果目錄：

- `<chess_results>/exp4_20_runtime_guarded_overlay`
- engine summary：`<chess_results>/exp4_20_runtime_guarded_overlay/exp4/summary.json`
- no-label guard cases：`<chess_results>/exp4_20_runtime_guarded_overlay/exp4/audits/exp4_runtime_guarded_overlay.jsonl`
