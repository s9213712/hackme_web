...
PYTHONPATH=<repo> python3 <repo>/scripts/games/chess_live_learning_validation.py \
  ...
  --output-root <chess_results>/exp4_19_guarded_overlay_attribution
```

結果目錄：

- `<chess_results>/exp4_19_guarded_overlay_attribution`
- engine summary：`<chess_results>/exp4_19_guarded_overlay_attribution/exp4/summary.json`
- overlay detail：`<chess_results>/exp4_19_guarded_overlay_attribution/exp4/audits/exp4_guarded_overlay_attribution.jsonl`
