...
```bash
python3 -m py_compile <repo>/services/games/chess_pv_guarded_overlay.py <repo>/scripts/games/chess_exp4_guarded_overlay_targeted_replay.py
```

```bash
PYTHONPATH=<repo> pytest <repo>/tests/scripts/games/test_chess_exp4_guarded_overlay_targeted_replay_script.py -q
```
...
```bash
PYTHONPATH=<repo> python3 <repo>/scripts/games/chess_exp4_guarded_overlay_targeted_replay.py --audit-json <repo>/runtime/chess_results/exp4_23_guarded_overlay_broad_sanity_gate_full/exp4/audits/exp4_guarded_overlay_unsafe_override_audit.json --output-json <repo>/runtime/chess_results/exp4_23_guarded_overlay_broad_sanity_gate_full/exp4/audits/exp4_guarded_overlay_targeted_replay_after_tightening.json --output-md <repo>/runtime/chess_results/exp4_23_guarded_overlay_broad_sanity_gate_full/exp4/audits/exp4_guarded_overlay_targeted_replay_after_tightening.md
```
...
- JSON：`<repo>/runtime/chess_results/exp4_23_guarded_overlay_broad_sanity_gate_full/exp4/audits/exp4_guarded_overlay_targeted_replay_after_tightening.json`
- Markdown：`<repo>/runtime/chess_results/exp4_23_guarded_overlay_broad_sanity_gate_full/exp4/audits/exp4_guarded_overlay_targeted_replay_after_tightening.md`
