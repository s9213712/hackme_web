...
```bash
python3 <repo>/scripts/games/chess_live_learning_validation.py --engines exp4 --quick-retrain-gate --seed 20260511 --quick-retrain-max-samples 220 --quick-retrain-max-seconds 120 --output-root <chess_results>/exp4_02_mcts_opening_multigood
```

```bash
python3 <repo>/scripts/games/chess_live_learning_validation.py --engines exp4 --quick-retrain-gate --seed 20260511 --quick-retrain-max-samples 220 --quick-retrain-max-seconds 120 --output-root <chess_results>/exp4_03_retention_fixture_clean
```

```bash
python3 <repo>/scripts/games/chess_live_learning_validation.py --engines exp4 --quick-retrain-gate --seed 20260511 --quick-retrain-max-samples 220 --quick-retrain-max-seconds 120 --output-root <chess_results>/exp4_04_probe_policy_fixed
```
...
```text
<chess_results>/exp4_04_probe_policy_fixed/summary.json
<chess_results>/exp4_04_probe_policy_fixed/SUMMARY.md
<chess_results>/exp4_04_probe_policy_fixed/exp4/summary.json
<chess_results>/exp4_04_probe_policy_fixed/exp4/SUMMARY.md
```
