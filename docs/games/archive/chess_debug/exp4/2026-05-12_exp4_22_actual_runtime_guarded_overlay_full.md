...
PYTHONPATH=<repo> python3 <repo>/scripts/games/chess_live_learning_validation.py \
  ...
  --output-root <chess_results>/exp4_22_actual_runtime_guarded_overlay_quick
```
...
PYTHONPATH=<repo> python3 <repo>/scripts/games/chess_live_learning_validation.py \
  ...
  --quick-retrain-max-samples 64 \
  --quick-retrain-max-seconds 90 \
  --output-root <chess_results>/exp4_22_actual_runtime_guarded_overlay_full
```
...
```text
<chess_results>/exp4_22_actual_runtime_guarded_overlay_quick
```
...
```text
<chess_results>/exp4_22_actual_runtime_guarded_overlay_full
```
