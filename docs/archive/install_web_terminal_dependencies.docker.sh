#!/usr/bin/env bash
# Archived from branch 02-WebTerminal-docker.
# Historical reference only: 02-WebTerminal-qemu intentionally deprecates
# Docker-based WebTerminal runtime and should not use this script as an
