...
| PointsChain | wallet、catalog/rules、disabled admin adjustment、ledger、seal/verify、disabled ledger backup endpoints、recovery status、一鍵異常鏈處理、economy stats，並驗 custom profile / 非 production 模式下的 production-only chain seal rejection guidance。 |
