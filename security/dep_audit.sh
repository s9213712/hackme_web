...
# Writes a Markdown report to security/reports/RUNID/dep_audit.md.
#
# Usage:
#   security/dep_audit.sh [--out DIR] [--fail-on-vuln]
#
# Options:
#   --out DIR          Output directory for reports (default: security/reports)
...
Options:
  --out DIR          Write reports under DIR (default: security/reports)
